...
import_company() {
    ...
    echo "    cd ~/ticketz-docker-acme && docker compose stop backend"
    echo "  or:"
    ...
    echo "    docker compose up -d backend"
    echo ""
    echo "  ⚠ IMPORTANT: planId and dueDate were reset to safe defaults."
    echo "  Update the company plan and expiry in the admin panel or via SQL."
    echo ""
    echo "  Safety backup: ${SAFETY_BACKUP}"
    echo "==================================================================="
    echo ""
